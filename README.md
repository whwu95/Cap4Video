...
## Data Preparing
All video datasets can be downloaded from their respective official links. In order to improve training efficiency, we have preprocessed these videos into frames, which we will package and upload for convenient reproduction of our results.
...
<h3>The text-video results on the MSR-VTT 1K-A test set.
Left: The ranking results of the query-video matching model.
Right: The ranking results of Cap4Video, which incorporates generated captions to enhance retrieval.</h3>
